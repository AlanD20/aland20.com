const projects = [
  {
    ...
    content:
      '@pg My personal portfolio which I built with Next.js along with Prisma to make it more contents dynamic and having an admin dashboard to Add/ Edit/ Delete contents inside the website. @endpg',
