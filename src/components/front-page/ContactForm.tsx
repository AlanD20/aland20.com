    ...
    <form onSubmit={handleOnSubmit} id="contact-form">
      <fieldset id="fields">
        ...
        <dialog id='dialog'>
          ...
          <div className="absolute border-4 border-primary-600 border-dashed animate-spin rounded-full w-full h-full"></div>
        ...
        <div className="field">
          ...
          <input type="email" name="email" id="email" required placeholder="e.g, johndoe@example.com" />
        </div>
        <div className="field">
