...
const SingleProject: NextPage<Props> = ({
  ...
  return (
    <SingleModelCard model={model} id={id}>
      ...
      <TextBlock title='Project Source Link:' content={sourceLink} link={sourceLink} />
      <TextBlock title='Project Preview Link:' content={previewLink} link={previewLink} />

      <TextBlock title='Created Date:' content={createdDate?.toString()} inline />

      <TextBlock title='Completed Date:' content={completedDate?.toString()} inline />
